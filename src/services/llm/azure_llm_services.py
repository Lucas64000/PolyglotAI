...
class AzureFoundryLLM:
    def __init__(self, api_version: str | None = None, api_key: str | None = None, model: str | None = None,
        ...
        self.temperature = temperature if temperature else config.llm_temperature
    ...
    def generate(self, messages: List[Dict[str, str]], system_prompt: str="You are helpful") -> str:
    ...
    def generate_json(self, messages: List[Dict[str, str]], system_prompt: str="You are helpful") -> Dict[str, str]:
    ...
    def generate_tool_call(self, messages: List[Dict[str, str]], tools: List[Dict[str, Any]], system_prompt: str = "You are a routing agent.") -> Any:
